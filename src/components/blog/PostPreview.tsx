  ...
  return (
    ...
    >
      <img
        ...
        loading="lazy"
        alt="post image"
        className="rounded-t-lg border-x-[1px] border-t-[1px] border-primary/50 sm:border-none sm:border-transparent object-cover opacity-95 sm:prose sm:w-5/6 sm:self-center md:hidden md:w-2/6 md:rounded-l-badge md:rounded-tr-none"
      />
      <img
        src={imageBig}
        loading="lazy"
      ...
      />
      <div className="prose flex h-full flex-col self-center rounded-b-lg border-[1px] border-primary/50 sm:border-none sm:border-transparent bg-white/80 px-4 py-3 sm:w-5/6 md:w-3/5 md:rounded-r-badge md:rounded-bl-none md:p-8 lg:w-3/6">
        <div className="prose">
          <h3
