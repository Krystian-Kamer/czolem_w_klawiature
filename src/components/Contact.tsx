  ...
  return (
    <div className="mx-8 flex flex-col md:mt-14 lg:mt-20">
      ...
      <form className="prose flex h-[60vh] w-full flex-col justify-around self-center border-4 border-dashed border-primary bg-accent p-8 md:mt-10 md:w-4/5 md:border-8 lg:w-1/2">
        <h1 className="uppercase">Pogadajmy</h1>
        <label className="input flex items-center gap-2 rounded-none bg-neutral font-protest text-lg tracking-wider">
          <svg
        ...
        <textarea
          className="textarea h-[30vh] w-full rounded-none bg-neutral font-protest text-lg tracking-wider"
          placeholder="O czym chciałbyś pogadać?"
        ></textarea>
        <p className="font-protest text-xl tracking-wider">
