...
const SectionTitle = ({ title, bgColor }: SectionTitleProps) => {
  return (
    <div className="relative w-fit">
      <h1
        className={`text-3xl tracking-wide sm:text-4xl lg:text-5xl ${bgColor === "bg-primary" ? "text-neutral selection:bg-primary-content selection:text-secondary" : "text-primary selection:bg-accent selection:text-secondary"}`}
      >
        {title}
      </h1>
      <div className="absolute -bottom-1 w-[120%] md:-bottom-5">
        {bgColor === "bg-primary" ? (
          <svg
