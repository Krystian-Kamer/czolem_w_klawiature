  ...
  return (
    <Section id="blog-1" bgColor="bg-neutral" height="h-fit" isLastChild={true}>
      <div className="mx-8 flex flex-col md:mt-14 lg:mt-20">
        ...
        <div className="last:mb-[100px] last:md:mb-[300px] last:lg:mb-[500px]">
          {posts.length === 0 ? (
            <div className="w-full text-center font-protest text-2xl tracking-wide selection:bg-accent selection:text-secondary md:text-3xl md:leading-relaxed md:tracking-wider lg:px-20 lg:text-4xl lg:leading-relaxed lg:tracking-wider">
