  ...
  return (
    <Section id="blog-1" bgColor="bg-neutral" height="h-fit" isLastChild={true}>
      <div className="relative mx-8 flex flex-col md:mt-14 lg:mt-20">
        ...
        <div className="z-10 w-full font-protest text-lg tracking-wide selection:bg-accent selection:text-secondary ph:text-xl md:w-4/5 md:text-2xl md:leading-relaxed md:tracking-wider lg:text-3xl lg:leading-relaxed lg:tracking-wider">
          ...
          <h3 className="hidden ph:flex mb-2 md:mb-2 lg:mb-4">
            Wybierz kategorię:
          </h3>
        </div>
