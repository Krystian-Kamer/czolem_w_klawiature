  ...
  return (
    ...
    >
      <div className="mx-8 flex flex-col md:mt-14 lg:mt-20">
        ...
        <div className="w-full font-protest text-lg tracking-wide md:tracking-wider selection:bg-accent md:leading-relaxed selection:text-secondary lg:leading-relaxed ph:text-xl md:w-4/5 md:text-2xl lg:text-3xl lg:tracking-wider">
